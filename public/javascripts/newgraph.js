...
$.post('/', { name: "John", time: "2pm" }, function(data){console.log(data)});
  ...
  // Time to prefill the form...
    ...
    if(obj.people !== null)
    {
      ...
      keypeople.forEach(function(d, i){
        ...
        d3.select('#key-people-' + i + ' input[name="kpeople"]').text(function(e){this.value = d;});
...
{
   d3.selectAll('#nickname').text(function(d){this.value = obj.nickname;});
    d3.selectAll('#twitterhandle').text(function(d){this.value = obj.twitterH;});
  ...
  if(obj.poruc !== null)
    {
      ...
      collaboration.forEach(function(d, i){
        ...
        d3.select('#collaboration-' + i + ' input[name="collaboration"]').text(function(e){this.value = d;});
        // d3.select('#key-people-' + i + " input[name='kpeople']").text(function(e){console.log(d.value); d.value = e});
      });
