          ...
          if (this.value) {
            if (!d3.selectAll('.fundgiven_amt')[0][i].value) {
              ...
              if(!d3.selectAll('.fundgiven_year')[0][i].value) {
                formObject.funding_given.push({name:this.value,amount:fund_given_amount, year:null});              
              }
              else
                formObject.funding_given.push({name:this.value,amount:fund_given_amount, year:d3.selectAll('.fundgiven_year')[0][i].value});              
            } else {
          ...
          if (this.value) {
            if (!d3.selectAll('.investmade_amt')[0][i].value) {
              ...
              if(!d3.selectAll('.investmade_year')[0][i].value) {
                formObject.investments_made.push({name:this.value,amount:investment_made_amount, year:null});              
              }
              else
                formObject.investments_made.push({name:this.value,amount:investment_made_amount, year:d3.selectAll('.investmade_year')[0][i].value});              
            } else {
    ...
    function add_input_fund_given(counterFG) {
      if ($('#fundinggiven-' + counterFG + ' input[name="fundgiven"]').val() !== "") {
        ...
        $("#fundinggiven-" + (counterFG - 1)).after('<div id="fundinggiven-' + counterFG + '"><div class="fundgiven-input input-control text" data-role="input-control">\
            <input type="text" name="fundgiven" class="fundee" placeholder="Fundee" style="display:inline-block; width:50%;"/>\
    ...
    function add_input_invest_made(counterIM) {
      if ($('#investmentmade-' + counterIM + ' input[name="investmade"]').val() !== "") {
        ...
        $("#investmentmade-" + (counterIM - 1)).after('<div id="investmentmade-' + counterIM + '"><div class="investmade-input input-control text" data-role="input-control">\
            <input type="text" name="investmade" class="investee" placeholder="Investee" style="display:inline-block; width:50%;"/>\
