      ...
      d3Layers.d3Routes = d3MapTools.addLayer({
        ...
        loaded: function(svg, projection) {
          ...
          this.pinpoints = svg.selectAll(".pinpoint")
            ...
            .style("fill", "rgb(23, 154, 190)")
            .style("stroke", "black")
            .attr("class", "pinpoint")
            .attr("opacity", 0)
            .attr("stroke-opacity", 0)
            .on('mouseout', function() {
              d3Layers.d3Routes.options.resetHover();
            })
            .on('mouseover', function(d) {
              d3Layers.d3Routes.options.highlightHover(d);
            })
            .on("click", function(d) {
              d3Layers.d3Routes.options.highlightClick(d);
            });
