          ...
          function displayFormB() {
            ...
            if (formObject.location && formObject.name) {
              ...
              placeholder = "Name of Entity" / > \
                < /div>\ < h3 class = "form-header" > Entity Type < /h
              3 > \ < div class = "webform-entities" > \
                < div data - role = "input-control"
              class = "input-control radio default-style webform" > \
                < label > \
                < input id = "rb_forpro"
              type = "radio"
              name = "entitytype"
              ...
              name = "nickname"
              id = "nickname"
              placeholder = "Nickname/Abbr." / > \
                < /div>\ < div class = "input-control text"
              data - role = "input-control" > \
                < input type = "text"
              name = "twitterhandle"
              id = "twitterhandle"
              placeholder = "Twitter Handle" / > \
                < /div>\ < h3 class = "form-header"
              ...
              placeholder = "Collaborator" / > \
                < /div>\ < h3 class = "form-header" > Revenue < /h
              3 > \ < div id = "revenue-0" > \
                < div class = "revenue-input input-control text"
              data - role = "input-control" > \
                < input type = "text"
              name = "revenue_amt"
              class = "revenue_amt"
              ...
              style = "display:inline-block; width: 20%;" / > \
                < /div>\ < /div > \ < h3 class = "form-header" > Expenses < /h3>\ < div id = "expense-0" > \ < div class = "expense-input input-control text"
              data - role = "input-control" > \
                < input type = "text"
              name = "expense_amt"
              class = "expense_amt"
              ...
              id = "submit-B"
              href = "javascript: check_empty()" > Submit < /button>\ < /div > ';
              ...
              function add_input_invest(counterI) {
                  ...
                  function add_input_fund_given(counterFG) {
                      if ($('#fundinggiven-' + counterFG + ' input[name="fundgiven"]').val() !== "") {
                        ...
                        $("#fundinggiven-" + (counterFG - 1)).after('<div id="fundinggiven-' + counterFG + '"><div class="fundgiven-input input-control text" data-role="input-control">\ < input type = "text"
                          name = "fundgiven"
                          class = "fundee"
                          placeholder = "Fundee"
                          style = "display:inline-block; width:50%;" / > \
                      ...
                      function add_input_invest_made(counterIM) {
                          if ($('#investmentmade-' + counterIM + ' input[name="investmade"]').val() !== "") {
                            ...
                            $("#investmentmade-" + (counterIM - 1)).after('<div id="investmentmade-' + counterIM + '"><div class="investmade-input input-control text" data-role="input-control">\ < input type = "text"
                              name = "investmade"
                              class = "investee"
                          ...
                          function add_input_rev(counterR) {
                              ...
                              function add_input_exp(counterE) {
                                  ...
                                  function displayFormA() {
                                    ...
                                    id = "name"
                                    placeholder = "Name of Entity" / > \
                                      < /div>\ < h3 class = "form-header" > What type of entity ? < /h
                                    3 > \ < div class = "webform-entities" > \
                                      < div data - role = "input-control"
                                    class = "input-control radio default-style webform" > \
                                      < label > \
                                    ...
                                    data - role = "input-control"
                                    style = "width:27% !important; display:inline-block; float:right; margin-top: 2%;" > \
                                      < input type = "text"
                                    name = "employees"
                                    id = "employee"
                                    maxlength = "6"
                                    style = "width:100% !important;" / > \
                                      < /div>\ < h3 class = "form-header" > Key People ? < /h
                                    ...
                                    placeholder = "Key Person\'s Name" / > \
                                      < /div>\ < h3 class = "form-header" > Who funds them via grants ? < /h
                                    3 > \ < div id = "funding-0" > \
                                      < div class = "fund-input input-control text"
                                    data - role = "input-control" > \
                                      < input type = "text"
                                    name = "fund"
                                    class = "funder"
                                    ...
                                    placeholder = "Year"
                                    style = "display:inline-block; width: 20%;" / > \
                                      < /div>\ < /div > \ < h3 class = "form-header" > Who invests in them via equity stakes(stock) ? < /h3>\ < div id = "investing-0" > \ < div class = "invest-input input-control text"
                                    data - role = "input-control" > \
                                      < input type = "text"
                                    name = "invest"
                                    class = "investor"
                                    ...
                                    placeholder = "Year"
                                    style = "display:inline-block; width: 20%;" / > \
                                      < /div>\ < /div > \ < h3 class = "form-header" > Who do they fund via grants ? < /h3>\ < div id = "fundinggiven-0" > \ < div class = "fundgiven-input input-control text"
                                    data -
                                      role = "input-control" > \
                                      < input type = "text"
                                    name = "fundgiven"
                                    ...
                                    placeholder = "Year"
                                    style = "display:inline-block; width: 20%;" / > \
                                      < /div>\ < /div > \ < h3 class = "form-header" > Who do they invest in via equity stakes(stock) ? < /h3>\ < div id = "investmentmade-0" > \ < div class = "investmade-input input-control text"
                                    data -
                                      role = "input-control" > \
                                      < input type = "text"
                                    name = "investmade"
                                    ...
                                    placeholder = "Year"
                                    style = "display:inline-block; width: 20%;" / > \
                                      < /div>\ < /div > \ < h3 class = "form-header" > Who provides them with data ? < /h3>\ < div id = "data-0"
                                    class = "input-control text"
                                    data - role = "input-control" > \
                                      < input type = "text"
                                    name = "data"
                                    ...
                                    placeholder = "Data Resource" / > \
                                      < /div>\ < div id = "nextPhase" > < span > Almost done... < /span > < button type = "button"
                                    id = "submit-A"
                                    href = "javascript: check_empty()" > Next < /button > < /div > \ < /div>\ < hr / > \
                                      < div class = "webform-footer" > \
                                      < span id = "" > Some entities lack adequate information.Would you like to help ? < /span><br/ > < span id = "toFormC" > Click here! < /span>\ < /div > ';
                                  ...
                                  function displayFormCSendJSON(obj) {
                                    ...
                                    class = "webform-content" > \
                                      < p > Thanks
                                    for submitting information to Athena! < /p>\ < p > Might you be interested in helping with other entities ? < /p > ';
                                    s += '<ul id="suggestions">';
                                      ...
                                      if (obj.funding_received !== null) {
                                        ...
                                        fundingreceived.forEach(function(d, i) {
                                            $("#funding-" + i).after('<div id="funding-' + (i + 1) + '"><div class="fund-input input-control text" data-role="input-control">\ < input type = "text"
                                              ...
                                              style = "display:inline-block; width: 20%;" / > \
                                              < /div></div > ');
                                              d3.select('#funding-' + i + ' input[name="fund"]').on('keyup', null); d3.select('#funding-' + i + ' input[name="fund"]').text(function(e) {
                                                this.value = d.entity;
                                        ...
                                        if (obj.funding_given !== null) {
                                          ...
                                          fundinggiven.forEach(function(d, i) {
                                              $("#fundinggiven-" + i).after('<div id="fundinggiven-' + (i + 1) + '"><div class="fundgiven-input input-control text" data-role="input-control">\ < input type = "text"
                                                name = "fundgiven"
                                                class = "fundee"
                                                placeholder = "Fundee"
                                                style = "display:inline-block; width:50%;" / > \
                                                ...
                                                style = "display:inline-block; width: 20%;" / > \
                                                < /div></div > ');
                                                d3.select('#fundinggiven-' + i + ' input[name="fundgiven"]').on('keyup', null); d3.select('#fundinggiven-' + i + ' input[name="fundgiven"]').text(function(e) {
                                                  this.value = d.entity;
                                          ...
                                          if (obj.investments_received !== null) {
                                            ...
                                            investmentreceived.forEach(function(d, i) {
                                                $("#investing-" + i).after('<div id="investing-' + (i + 1) + '"><div class="invest-input input-control text" data-role="input-control">\ < input type = "text"
                                                  ...
                                                  style = "display:inline-block; width: 20%;" / > \
                                                  < /div></div > ');
                                                  d3.select('#investing-' + i + ' input[name="invest"]').on('keyup', null); d3.select('#investing-' + i + ' input[name="invest"]').text(function(e) {
                                                    this.value = d.entity;
                                            ...
                                            if (obj.investments_made !== null) {
                                              ...
                                              investmentsmade.forEach(function(d, i) {
                                                  $("#investmentmade-" + i).after('<div id="investmentmade-' + (i + 1) + '"><div class="investmade-input input-control text" data-role="input-control">\ < input type = "text"
                                                    name = "investmade"
                                                    class = "investee"
                                                    placeholder = "Investee"
                                                    style = "display:inline-block; width:50%;" / > \
                                                    ...
                                                    style = "display:inline-block; width: 20%;" / > \
                                                    < /div></div > ');
                                                    d3.select('#investmentmade-' + i + ' input[name="investmade"]').on('keyup', null); d3.select('#investmentmade-' + i + ' input[name="investmade"]').text(function(e) {
                                                      this.value = d.entity;
                                              ...
                                              if (obj.expenses !== null) {
                                                ...
                                                expenseValues.forEach(function(d, i) {
                                                    $("#expense-" + i).after('<div id="expense-' + (i + 1) + '"><div class="expense-input input-control text" data-role="input-control">\ < input type = "text"
                                                      ...
                                                      style = "display:inline-block; width: 20%;" / > \
                                                      < /div></div > ');
                                                      d3.select('#expense-' + i + ' input[name="expense_amt"]').on('keyup', null); d3.select('#expense-' + i + ' input[name="expense_amt"]').text(function(e) {
                                                        this.value = d.amount;
                                                ...
                                                if (obj.revenue !== null) {
                                                  ...
                                                  revenueValues.forEach(function(d, i) {
                                                      $("#revenue-" + i).after('<div id="revenue-' + (i + 1) + '"><div class="revenue-input input-control text" data-role="input-control">\ < input type = "text"
                                                        ...
                                                        style = "display:inline-block; width: 20%;" / > \
                                                        < /div></div > ');
                                                        d3.select('#revenue-' + i + ' input[name="revenue_amt"]').on('keyup', null); d3.select('#revenue-' + i + ' input[name="revenue_amt"]').text(function(e) {
                                                          this.value = d.amount;
