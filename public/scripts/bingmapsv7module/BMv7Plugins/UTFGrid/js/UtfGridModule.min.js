var UtfGrid;(function(){UtfGrid=function(e,t,n){function u(e){h(n);if(o.jsonp){t=f(t)}var s=new Microsoft.Maps.TileSource({uriConstructor:function(n){if(n.levelOfDetail>o.maxZoomLevel)return;var r=n.levelOfDetail+"_"+n.x+"_"+n.y;if(i[r]==undefined){l(n,t)}}});r=new Microsoft.Maps.TileLayer({mercator:s});if(o.mouseoverCallback!=undefined){Microsoft.Maps.Events.addHandler(e,"mousemove",function(e){a(e)})}if(o.mouseclickCallback!=undefined){Microsoft.Maps.Events.addHandler(e,"click",function(e){a(e)})}}function a(t){var n=e.getZoom();var r=t.getX();var u=t.getY();var a=new Microsoft.Maps.Point(r,u);var f=e.tryPixelToLocation(a);var l=p(f.latitude,f.longitude,n);var h=l.x/256;var d=l.y/256;var v=(h-Math.floor(h))*256;var m=(d-Math.floor(d))*256;var g=i[n+"_"+Math.floor(h)+"_"+Math.floor(d)];if(g==undefined||g.grid==undefined){return}var y=Math.floor(m/o.tileSize);var b=Math.floor(v/o.tileSize);var w=g.grid[y];if(w!=undefined){var E=w.charCodeAt(b);var S=c(E);var x=g.keys[S];var T=g.data[x];if(T!=undefined&&x!=s){s=x}else if(T==undefined&&s!=undefined){s=undefined;T=undefined}if(t.eventName=="mousemove"){o.mouseoverCallback(T)}if(t.eventName=="click"){o.mouseclickCallback(T)}}}function f(e){var t="callback";var n="grid";var r=new RegExp("([?|&])"+t+"=.*?(&|$)","i");var i=e.indexOf("?")!==-1?"&":"?";if(!e.match(r)){return e+i+t+"="+n}}function l(e,t){var n=e.x;var r=e.levelOfDetail;var s=e.y;var u=t;u=u.replace("{z}",r);u=u.replace("{x}",n);u=u.replace("{y}",s);reqwest({url:u,type:o.jsonp?"jsonp":"json",success:function(t){var u=r+"_"+n+"_"+s;i[u]=t;if(o.tileLoadedCallback!=undefined){o.tileLoadedCallback(e)}}})}function c(e){if(e>=93){e--}if(e>=35){e--}return e-32}function h(e){for(attrname in e){o[attrname]=e[attrname]}}function p(e,t,n){var r=Math.sin(e*Math.PI/180);var i=(t+180)/360*256*(2<<n-1);var s=(.5-Math.log((1+r)/(1-r))/(4*Math.PI))*256*(2<<n-1);var o=new Object;o.x=.5+i|0;o.y=.5+s|0;return o}var r={};var i={};var s;var o={mouseclickCallback:undefined,mouseoverCallback:undefined,tileLoadedCallback:undefined,jsonp:true,tileSize:4,maxZoomLevel:20};this.getTileData=function(e){return i[e.z+"_"+e.x+"_"+e.y]};this.getTileSize=function(){return o.tileSize};u(e);return r};
