...
2.       For Macs, the ŒÈŒÌMAMPŒÈŒÌ folder can be found under Applications. For Windows, the ŒÈŒÌwampŒÈŒÌ folder can be found under C:
3.       Clone the Github repo to htdocs under the ŒÈŒÌMAMPŒÈŒÌ folder if on a Mac machine, or clone the Github repo to www under the ŒÈŒÌwampŒÈŒÌ folder if on a Windows machine.
